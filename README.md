...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-redis-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13172&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-redis-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-redis` can be installed with:

```
conda install types-redis
```

It is possible to list all of the versions of `types-redis` available on your platform with:
